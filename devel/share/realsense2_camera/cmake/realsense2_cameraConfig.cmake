...
if("TRUE" STREQUAL "TRUE")
  set(realsense2_camera_SOURCE_PREFIX /home/irsl/ysm_ws/teleop_ws/src/realsense-ros/realsense2_camera)
  set(realsense2_camera_DEVEL_PREFIX /home/irsl/ysm_ws/teleop_ws/devel)
  ...
  set(realsense2_camera_INSTALL_PREFIX /home/irsl/ysm_ws/teleop_ws/install)
...
if(NOT "/home/irsl/ysm_ws/teleop_ws/devel/include " STREQUAL " ")
  set(realsense2_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/irsl/ysm_ws/teleop_ws/devel/include")
  ...
  elseif(NOT "http://www.ros.org/wiki/RealSense " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Doron Hirshberg <doron.hirshberg@intel.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/irsl/ysm_ws/teleop_ws/src/realsense-ros/realsense2_camera/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT realsense2_camera_NUM_DUMMY_TARGETS)
      set(realsense2_camera_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::realsense2_camera::wrapped-linker-option${realsense2_camera_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR realsense2_camera_NUM_DUMMY_TARGETS "${realsense2_camera_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::realsense2_camera::wrapped-linker-option${realsense2_camera_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND realsense2_camera_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(realsense2_camera_EXPORTED_TARGETS ${${realsense2_camera_dep}_EXPORTED_TARGETS})
endforeach()
